...
ninja_build_wind_url = function(lat, lon, from, to, dataset='merra2', capacity=1, height, turbine='Vestas+V150+4000', raw='true', format='csv')
{
...
ninja_build_solar_url = function(lat, lon, from, to, dataset='merra2', capacity=1, system_loss, tracking, tilt, azim, raw='true', format='csv')
{
  from = format_date(from)
  to = format_date(to)
...
# zero error checking :(
#
ninja_get_wind = function(lat, lon, from, to, dataset='merra2', capacity=1, height, turbine='Vestas+V150+4000', raw='true')
{
...
ninja_get_solar = function(lat, lon, from, to, dataset='merra2', capacity=1, system_loss, tracking, tilt, azim, raw='true')
{
...
#
ninja_aggregate_wind = function(lat, lon, from='2014-01-01', to='2014-12-31', dataset='merra2', capacity=1, height=100, turbine='Vestas+V80+2000', name=NULL)
{
